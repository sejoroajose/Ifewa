...
export default function Testimonials() {
    ...
    return (
      <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto font-aime">
        <h2 className="text-4xl md:text-5xl text-center mb-16 text-gray-900 font-aime">
          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="flex flex-col">
              <div className="bg-[#B7D1DA] bg-opacity-40 p-6 rounded-lg mb-8 relative">
                <p className="text-gray-600 leading-relaxed font-aime">{testimonial.text}</p>
                <div
              ...
              <div className="flex items-center justify-center mt-8 space-x-3">
                ...
                <div>
                  <h3 className="font-aime text-xl text-gray-900">{testimonial.name}</h3>
                  <p className="text-blue-500 font-aime">{testimonial.role}</p>
                </div>
              </div>
            </div>
          ))}
